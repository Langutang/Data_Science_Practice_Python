...
# Define function Bootstrap replicates
...
# Define function to pair bootstrap in linear regression
...
# How can we explain this transfer of genetric trait of beak length? Let's analyze heritability
...
# Define a function to take a bootstap simulation statistics
...
# P-value of ~0, Strongly suggests that beak depth is heritable in G. Scandens just not as much as G. fortis
